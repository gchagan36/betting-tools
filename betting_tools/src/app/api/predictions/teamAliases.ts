...
const TEAM_NAME_GROUPS: Record<string, string[]> = {
  ...
  "Arkansas State": ["Arkansas State", "Arkansas St."],
  "Ball State": ["Ball State", "Ball St."],
  "Boise State": ["Boise State", "Boise St."], 
  "Cal Baptist": ["Cal Baptist", "California Baptist"],
  "Cal State Bakersfield": ["Cal State Bakersfield", "CSU Bakersfield", "Cal St. Bakersfield"],
  "Cal State Fullerton": ["Cal State Fullerton", "CSU Fullerton", "Cal St. Fullerton"],
  "Cal State Northridge": ["Cal State Northridge", "Cal St. Northridge", "CSUN"],
  ...
  "East Tennessee State": ["East Tennessee State", "East Tennessee St."],
  ...
  "Georgia State": ["Georgia State", "Georgia St."],
  "Grambling State": ["Grambling State", "Grambling St."],
  ...
  "Mississippi Valley State": ["Mississippi Valley State", "Mississippi Valley St."],
  ...
  "South Carolina State": ["South Carolina State", "South Carolina St."],
  ...
  "Youngstown State": ["Youngstown State", "Youngstown St."],
};
